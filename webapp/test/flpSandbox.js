		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gestioneattivazioneclausole-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gestioneattivazioneclausole-display": {
								"semanticObject": "gestioneattivazioneclausole",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gestioneattivazioneclausole",
									"url": sap.ui.require.toUrl("gestioneattivazioneclausole")
								}
							}
						}
					}
